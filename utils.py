...
def label_map_fn(json_file_path):
  ...
  for i in range (0,len(categories)):
    voc_labels.append(str(categories[i]["name"]))
...
# def create_data_lists(data_folder_path, output_folder):
#     """
...
#     #train_images = glob.glob1(os.path.join(data_folder_path,'images'), '*.jpg')
